...
class viewTest extends \PHPUnit_Framework_TestCase {
	...
	public function testParseTemplate() {
		...
		$this->assertEquals('view_paththeme_name/CONTROLLER_NAME/template_name.html', $method->invoke($view_instance, 'template_name'));
	}
	...
	public function testGetThemePath() {
		...
		$method->setAccessible(TRUE);
		$this->assertEquals('view_paththeme_name/', $method->invoke($view_instance));
	}
}
